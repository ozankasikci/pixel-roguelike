...
| 21. Feature Module Reorganization | — | 3/3 | Complete   | 2026-04-07 |
...
Plans:
- [x] 21-01-PLAN.md — Create door module directory, populate with all door source files, set up game_module_door CMake target
- [x] 21-02-PLAN.md — Build parser/serializer and action handler registration protocols, wire DoorSerializer and DoorActionHandler
- [x] 21-03-PLAN.md — Wire registerDoorModule at startup, update include paths, delete old files, update tests, verify build
