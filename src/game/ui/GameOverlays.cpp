...
void GameOverlays::renderMovementOverlay(PlayerMovementComponent& movement, bool grounded) {
...
void GameOverlays::renderViewmodelOverlay(ViewmodelComponent& vm) {
...
void GameOverlays::renderInteractionPrompt(const char* text, bool busy) {
...
void GameOverlays::renderInventory(InventoryMenuState& menu,
