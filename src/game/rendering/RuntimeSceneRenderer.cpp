...
constexpr float kPlayerTorchIntensity = 0.5f;
...
constexpr float kPlayerTorchSpillIntensity = 8.0f;
constexpr float kPlayerTorchHaloRadius = 5.4f;
constexpr float kPlayerTorchHaloIntensity = 4.0f;
...
constexpr float kPlayerHandGlowIntensity = 0.3f;
